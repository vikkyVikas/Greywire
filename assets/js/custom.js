...
$(document).ready(function() {
	...
	var typedhero = new Typed('#typedhero', {
		strings: ['IT Infrastructure Services', 'Network Design and Implementation', 'Cloud Computing Solutions', 'Cybersecurity Solutions','Managed IT Services','IT Consultancy Services'],
		typeSpeed: 30,
		backSpeed: 50,
		smartBackspace: true,
		loop: true
